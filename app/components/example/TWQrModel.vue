<template>
  ...
  <section class="body-font h-screen bg-gray-100 pt-10 text-gray-600">
    <div
      class="container mx-auto mt-10 flex max-w-3xl flex-wrap justify-center rounded-lg bg-white px-5 py-24"
    >
      ...
      <div class="flex-wrap md:flex">
        <div class="mx-auto">
          ...
          <button
            class="mx-auto block rounded-md border bg-blue-500 px-6 py-2 text-white outline-none"
          >
            ສົ່ງຫຼັກຖານການໂອນ
          </button>
        </div>
        ...
        <div class="mt-8 max-w-sm md:mt-0 md:ml-10 md:w-2/3">
          <div class="relative flex pb-12">
            ...
            <div class="flex-grow pl-4">
              <h2
                class="title-font mb-1 text-sm font-medium tracking-wider text-gray-900"
              >
                STEP 1
              </h2>
              <p class="font-laonoto leading-relaxed">
                ຊຳລະເງິນດ້ວຍການສະແກນຈ່າຍຜ່ານ <br />
          ...
          <div class="relative flex pb-12">
            ...
            <div class="flex-grow pl-4">
              ...
              <p class="font-laonoto leading-relaxed">
                ແຈ້ງຫຼັກຖານການຊຳລະເງິນດ້ວຍ <b>ຮູບໃບບິນ</b> ຫຼື
                <b>ຮູບສະລິບການໂອນ</b>.
              </p>
            </div>
          </div>
          <div class="relative flex pb-12">
            ...
            <div class="flex-grow pl-4">
              ...
              <p class="font-laonoto leading-relaxed">
                ສຳເລັດການໂອນ ກະລຸນາລໍຖ້າພະນັກງານກວດສອບ
                ທ່ານສາມາດກວດສອບສະຖານະການຊຳລະສຳເລັດໄດ້ ໄປທີ່ໜ້າ
